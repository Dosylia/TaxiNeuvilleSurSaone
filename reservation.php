...
<head>
    <meta charset="UTF-8">
    <title>Taxi Neuville sur Saône - Réservation</title>
    ...
    <link rel="canonical" href="https://taxi-neuvillesursaone.fr/reservation">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<section class="reservation container">
    <h1>Réservation</h1>
    <p>Choisissez votre type de trajet et renseignez vos coordonnées pour réserver votre transport.</p><br>
    <form action="reservation-handle.php" method="POST" id="reservationForm">
        ...
        <div class="radio-group">
            <label><input type="radio" id="taxi" name="transport" value="taxi" onchange="showOptions()" checked> Taxi (Gare/Aéroport)</label>
            <label><input type="radio" id="vsl" name="transport" value="vsl" onchange="showOptions()"> VSL (Transport Sanitaire)</label>
        </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="radio-group">
            <label><input type="radio" id="gare" name="destination" value="gare"> Gare</label>
            <label><input type="radio" id="aeroport" name="destination" value="aeroport"> Aéroport</label>
            </div>
        </fieldset>
        </div>

        <div id="vslOptions" style="display:none;">
        <fieldset>
            <legend>Type de transport médical :</legend>
            <div class="radio-group">
            <label><input type="radio" id="rendezvous" name="medical" value="rendezvous"> Rendez-vous médical</label>
            <label><input type="radio" id="dialyse" name="medical" value="dialyse"> Dialyse</label>
            </div>
        </fieldset>
        </div>
